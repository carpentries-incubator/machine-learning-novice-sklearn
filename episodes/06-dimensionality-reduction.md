...
![](fig/mnist_pairplot_pixels.png){alt='SKLearn image with highlighted pixels'}
...
![](fig/pca_clustered.png){alt='Reduction using PCA'}
...
![](fig/pca_3d.svg){alt='Reduction to 3 components using pca'}
...
![](fig/tsne_3d.svg){alt='Reduction to 3 components using tsne'}
